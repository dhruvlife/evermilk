...
import 'package:milkride/feature/product/presentation/screen/option_sheet/widgets/option_sheet_loader.dart';
...
class _ProductOptionSheetState extends State<ProductOptionSheet> {
  ...
  void initState() {
    super.initState();
    getIt<ProductVariantCubit>().fetchProductVariants(prodVarParam:widget.prodDetailParam);
  }
  @override
      ...
      child: BlocBuilder<ProductVariantCubit, ProductVariantState>(
        builder: (context, state) {
          if (state is ProductVariantLoading) {
            ...
            return Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    AppText(data: product?.name ?? "", fontWeight: FontWeight.bold),
                    IconButton(
                        onPressed: () => Get.back(),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: SelectedButton(
                              ...
                              isSlected: false,
                              onPressed: () {
                                Get.toNamed(RoutesName.subscribePage,arguments: product!);
                              },
                            ),
                          ),
                        ],
            ...
            return Center(child: NetworkFailCard(
              messege: state.message,isButtonRequired: true,buttonText: AppStrings.retry,onButtontap: () {
                cubit.fetchProductVariants(prodVarParam: widget.prodDetailParam);
              },
            ));
          }
          return SizedBox();
