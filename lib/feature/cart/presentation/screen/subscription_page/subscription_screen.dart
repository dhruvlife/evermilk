...
import 'package:milkride/feature/cart/presentation/screen/subscription_page/widgets/date_picker_section.dart';
import 'package:milkride/feature/cart/presentation/screen/subscription_page/widgets/delivery_type_section.dart';
import 'package:milkride/feature/cart/presentation/screen/subscription_page/widgets/schedule_card.dart';
import 'package:milkride/feature/cart/presentation/screen/subscription_page/widgets/subcription_prod_card.dart';
    ...
    return Scaffold(
      ...
      body: BlocBuilder<SubscriptionCubit, SubscriptionState>(
        ...
        builder: (context, state) {
          if (state is! SubscriptionLoaded) return const SizedBox();
          ...
          return ListView(
            ...
            children: [
              SubcriptionProdCard(
                ...
                onQuautIncrease: () => cubit.updateQuantity(state.quantity + 1),
                onQuautreduce: () {
                  if (state.quantity > 1) {
                  ...
                  children: List.generate(7, (index) {
                    return ListTile(
                      ...
                      trailing: QuantityButton(
                        ...
                        onIncreaseQuant: () => cubit.updateDayWiseQuantity(index, state.dayWiseQuantities[index] + 1),
                        onReduceQuant: () {
      ...
      bottomNavigationBar: SafeArea(
        child: CustomElevatedButton(
          ...
          onPressed: () {
            ...
            final frequencyValue = schedule == AppStrings.dayWise
                ? "[${cubit.dayWiseQuantities.join(",")}]"
                : schedule == AppStrings.every3Day ? "3" : schedule == AppStrings.alternateDay ? "2" : "1";
            final dayWiseQty = schedule == AppStrings.dayWise ? cubit.dayWiseQuantities.join(",") : "";
