...
class SeasonalSection extends StatelessWidget {
  final List<Product> seasonalProds;
  const SeasonalSection({super.key, required this.seasonalProds});
  @override
  Widget build(BuildContext context) {
    final uniqueProds = Operation.getUniqueProductsByProductId(products:seasonalProds);
    return SizedBox(
